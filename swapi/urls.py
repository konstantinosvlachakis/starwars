...
urlpatterns = [
    ...
    path("characters/<int:character_id>/vote/", CharacterVoteAPIView.as_view(), name="character-upvote"),
    path("films/<int:film_id>/vote/", FilmVoteAPIView.as_view(), name="film-upvote"),
    path("starships/<int:starship_id>/vote/", StarshipVoteAPIView.as_view(), name="starship-upvote"),
]
